...
const PitchCoachPage = () => (
  <div className="flex flex-col items-center justify-center min-h-screen px-8 py-16 text-center">
    ...
    >
      <div className="w-full h-1.5 rounded-full mb-3" style={{ background: "#2e2c28" }} />
      <div className="w-3/4 h-1.5 rounded-full mb-3" style={{ background: "#2e2c28" }} />
      <div className="w-1/2 h-1.5 rounded-full" style={{ background: "#2e2c28" }} />
    </div>
